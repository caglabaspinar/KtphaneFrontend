...
// Seçilen kütüphaneye ait kitapları RecyclerView üzerinde listelemek için kullanılan adapter sınıfıdır.
// Book modelini ekrana bağlar ve kitap tıklama olayını ilgili ekrana callback ile iletir.